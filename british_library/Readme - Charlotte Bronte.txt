...
The British Library 'Charlotte Brontë' dataset is a set of .csv (comma separated value) files containing metadata for resources relating to the author Charlotte Brontë, from the British National Bibliography (BNB) and our British Library collections. It is updated annually on the anniversary of Brontë's birth in April 1816.
